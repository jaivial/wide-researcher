...
const CURRENT_VERSION = (() => {
    try {
        ...
        const raw = JSON.parse(fsSync.readFileSync(pkgPath, 'utf8'));
...
export async function cleanStaleNpxCache() {
    ...
    for (const hash of entries) {
        const pkgJsonPath = path.join(npxRoot, hash, 'node_modules', 'wide-researcher', 'package.json');
        try {
...
//# sourceMappingURL=npx-cache.js.map