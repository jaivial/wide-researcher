...
export type { ProjectIdentity, InstallBundleOptions, UninstallBundleOptions, } from './claude-bundle.js';
 ...
 */
export declare function installGlobalInfra(opts: InstallAllOptions): Promise<void>;
