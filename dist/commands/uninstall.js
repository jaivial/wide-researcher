...
import { deriveProjectIdentity, uninstallClaudeBundle, uninstallIndexerSupervisor, uninstallQdrantSupervisor, } from '../installers/index.js';
...
export async function runUninstall(opts = {}) {
    ...
    if (opts.dropCollection && (await exists(id.configPath))) {
        try {
            ...
            log.warn(`drop-collection failed (collection may already be gone): ${e.message}`);
        }
    }
